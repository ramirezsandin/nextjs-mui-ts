...
const AlertCallerContext = createContext<AlertCallerContextType>({} as AlertCallerContextType)
...
const AlertCallerProvider = memo<AlertUpdateProviderProps>(({ children, setState }) => {
    return (
...
// Alert State Context
const AlertStateContext = createContext<AlertStateContextType>({} as AlertStateContextType)
